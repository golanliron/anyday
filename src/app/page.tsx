  ...
  return (
    <div dir="rtl" className="root">
      ...
      <section id="pricing" className="pricing">
        ...
        <div className="plans">
          {[
            { name: "סטארטר", price: "250", items: ["בורד אחד","100 פעולות בחודש","בניית בורדים בעברית"], cta: "להתחיל בחינם →", badge: "לנסות" },
            { name: "צוות", price: "450", items: ["דוחות PDF להנהלה","התראות חכמות","500 פעולות בחודש"], cta: "להתחיל →" },
            { name: "ארגון", price: "750", items: ["אוטומציות מלאות","לוח חי","2,000 פעולות בחודש","בורדים ללא הגבלה"], cta: "להתחיל →", pop: true },
